...
public class HashMaps {
    ...
    -> There are four fields in HashMap
     ...
     2. hashCode(): This is the method of Object class. It returns the memory reference of the object in the integer form. The value
                    ...
                    map. HashCode of a null key is 0.
    ...
    public static void main(String[] args) {
        Map<Integer,String> hm1 = Collections.synchronizedMap(new HashMap<>());
        hm1.put(1,"one");
        hm1.put(2,"two");
        hm1.put(3,"three");
        // all methods to define the constructor of hashmap
